...
To test this demo, you can run [gatt_security_client_demo](../gatt_security_client), which starts scanning, connects to and starts encryption with `wrx_footwell_led_demo` automatically.
...
Please check the [tutorial](tutorial/wrx_footwell_led_Example_Walkthrough.md) for more information about this example.
